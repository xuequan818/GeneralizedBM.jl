...
function hamIntra_BM(Lat::TBLG, basis::Basis, h::Hopping, q::Vector{Float64})
    hG1 = h.h11.hGv
    dhG1 = h.h11.dhGv
    hG2 = h.h22.hGv
    dhG2 = h.h22.dhGv
...
function hamInter_BM(Lat::TBLG, basis::Basis, h::Hopping, q::Vector{Float64})
    Kt = h.Kt[3]
    hF12 = h.h12.hFT
    hF21 = h.h21.hFT
    Btau = h.Bτ
...
ham_BM(Lat::TBLG, basis::Basis, h::Hopping, q::Vector{Float64}) = hamIntra_BM(Lat, basis, h, q) + hamInter_BM(Lat, basis, h, q)